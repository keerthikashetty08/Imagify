...
const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
        <div className='text-stone-500 inline-flex text-centre gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500'>
        ...
        <button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2 flex items-center gap-2 rounded-full'>Generate Images 
